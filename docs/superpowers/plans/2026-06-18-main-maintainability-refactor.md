...
- [x] **Step 1: Extract small data containers and helpers**
...
- [x] **Step 2: Keep `pipeline(...)` as the public orchestrator**
...
- [x] **Step 1: Centralize algorithm invocation**
...
- [x] **Step 2: Centralize registry constants and config parsing helpers**
...
- [x] **Step 3: Run targeted algorithm tests**
